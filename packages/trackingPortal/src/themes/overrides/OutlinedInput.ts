...
import { ColorProps } from "@trackingPortal/types/extended";

// project import
import getColors from "@trackingPortal/utils/getColors";
import getShadow from "@trackingPortal/utils/getShadow";
